                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="nid" class="form-control"
                                               placeholder="Enter Employe NID Number" name="nid" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="experience" class="form-control"
                                               placeholder="Enter Employe Experience" name="experience">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="salary" class="form-control"
                                               placeholder="Enter Employe Salary" name="salary" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="holiday" class="form-control"
                                               placeholder="Enter Employe Holiday Status" name="holiday" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept="image/*" class="form-control" name="image" onchange="readURL(this);">
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
