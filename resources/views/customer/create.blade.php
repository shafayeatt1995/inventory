                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control"
                                               placeholder="Enter Employe name" name="name" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="email" id="email_address_2" class="form-control"
                                               placeholder="Enter Employe email address" name="email" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="tel" id="phone" class="form-control"
                                               placeholder="Enter Employe Phone Number" name="phone" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="address" class="form-control"
                                               placeholder="Enter Employe Address" name="address" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="shopname" class="form-control"
                                               placeholder="Enter Customer Shop Name" name="shopName" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="accountholder" class="form-control"
                                               placeholder="Enter Bank Account Name" name="accountHolder">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="accountnumber" class="form-control"
                                               placeholder="Enter Customer Bank Account Number" name="accountNumber" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="bankname" class="form-control"
                                               placeholder="Enter Employe Bank Name" name="bankName" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="bankBranchName" class="form-control"
                                               placeholder="Enter Employe Bank Branch Name" name="bankBranch" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="bkashNumber" class="form-control"
                                               placeholder="Enter Employe Bank Branch Name" name="bkashNumber" required>
                                    </div>
                                </div>
                            </div>
                        </div>
